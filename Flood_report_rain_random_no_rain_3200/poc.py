...
# read csv files
df = pd.read_csv('Flood_report_rain_random_no_rain_3200.csv')
...
rf_model = RandomForestRegressor(n_estimators=1000, min_samples_split= 5, min_samples_leaf = 4, max_features = 'sqrt', max_depth = 80, bootstrap = True)
