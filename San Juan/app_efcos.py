...
st.write("""
# Metro Manila River Flood Prediction App for San Juan
""")
...
#
# ## Load StandardScaler
load_scaler = pickle.load(open('standscaler.pkl', 'rb'))

user_features_scaler = load_scaler.transform(user_features)
